...
def path_callback(path_msg):
    global trajectory, next_point_idx
...
def position_control(): 
    ...
    if next_point_idx < len(trajectory):

        goal_pose = trajectory[next_point_idx].pose.position
...
if __name__ == '__main__':
    try:
        ...
        rospy.Subscriber("spline_generator/out/path", Path, path_callback)
